...
export const metadata: Metadata = {
  ...
  description: "Inside a fifteen-second fictional chocolate concept: a Blender camera study, original package direction and a planned Seedance and ElevenLabs finish. Explore the production decisions shot by shot.",
};
...
const STAGES = [
  ...
  { n: "03", title: "Develop the appearance", state: "Planned", body: "Approve the food, filling and character references, then test Seedance against the camera guide. Keep stable package lettering and the printed report in Blender or compositing." },
      ...
      <main id="velune-main">
        <section className={`${styles.wrap} ${styles.hero}`}>
          ...
          <aside className={styles.heroNote}>
            ...
            <p>A working look at the direction, geometry and edit. The Seedance finish and ElevenLabs soundtrack are still ahead.</p>
        ...
        <section className={styles.artSection} aria-labelledby="art-heading">
          <div className={styles.wrap}>
            <div className={styles.sectionHead}><div><p className={styles.eyebrow}>03 / A consistent world</p><h2 id="art-heading">Three centres.<br /><em>One family.</em></h2></div><p>Pistachio Praline, Raspberry Ganache and Salted Caramel share one chocolate shell. Muted green, berry and amber distinguish the centres against cocoa, plum and cream.</p></div>
            <figure className={styles.packaging}>
              ...
              <figcaption>Supplied concept artwork · Flat illustrations awaiting hero product renders. Packaging design study, not a retail-ready label.</figcaption>
            </figure>
        ...
        <section className={`${styles.wrap} ${styles.section}`} aria-labelledby="workflow-heading">
          <div className={styles.sectionHead}><div><p className={styles.eyebrow}>04 / Production in the open</p><h2 id="workflow-heading">The route to the final film.</h2></div><p>The current evidence is the brief, artwork and camera study. Appearance generation, audio auditioning and the final mix are separate stages with their own review.</p></div>
        ...
        <section className={`${styles.wrap} ${styles.credits}`}>
          <div><p className={styles.eyebrow}>Direction & process</p><h2>Ajwad Rauf</h2><p>Creative direction and production review, with AI assistance for the brief and technical build. Blender supplies the editable scene and camera guide. Seedance and ElevenLabs are planned finishing tools.</p></div>
