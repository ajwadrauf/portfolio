      ...
      */}
      ...
      <div className={styles.flow}>
        ...
        {supportsRefs && (
          ...
          >
            {h3 && <p className="mt-3 text-xs leading-relaxed text-muted">Up to 9 images, 3 videos and 3 audio clips; at most 12 files combined. Video references: 2–15 seconds each, 15 seconds combined. Audio references: the same limits. Appearance images use Image 1, Image 2…; the motion guide is Video 1.</p>}
