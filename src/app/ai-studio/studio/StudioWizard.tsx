...
export function StudioWizard() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      ...
      {project?.example === "velune" && <div className="mt-4 rounded-lg border border-accent/30 bg-accent/5 p-4 text-sm"><strong>VELUNE · fictional concept study.</strong> The supplied packaging reference is visual direction, not final approved pack artwork. New example copies use the three-carton image; existing briefs keep their chosen source. Review the brief and generate a hero only when ready. The supplied H3 film and separate ElevenLabs voiceover can be played on the VELUNE page.</div>}
