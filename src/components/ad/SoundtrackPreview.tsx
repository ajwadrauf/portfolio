...
type Props = { soundtrackUrl: string; videoUrl: string | null; originalAudioAvailable: boolean };

/** The WAV is the playback clock. Original video sound is an audition layer only. */
export function SoundtrackPreview({ soundtrackUrl, videoUrl, originalAudioAvailable }: Props) {
  ...
  return <div className={styles.preview}>
    <div className={styles.previewHeading}><h4>Listen with the picture</h4><span>Playback preview</span></div>
    {videoUrl && originalAudioAvailable && <div className={styles.originalControls}>
      ...
      <p>Hear the sound generated with your video alongside this WAV. This switch and volume affect the preview only; original video sound is not added to the WAV or editor bundle.</p>
    </div>}
    ...
    <p className={styles.previewNote}>Play, pause and seek with the soundtrack player. Check final synchronization and combined levels in your editor.</p>
  </div>;
}
