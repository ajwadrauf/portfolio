          ...
          {plan.narration !== "none" && <>
            ...
            {plan.narration === "external" && <>
              ...
              {take && <div className="space-y-2 border-t border-border-soft pt-3">
                <p className="text-xs text-muted">{take.mock ? "Demo tone · no speech was generated" : take.recovered ? "Recovered voice assigned. Listen to check the words and delivery against this scene." : fresh ? "Voice take ready" : "Earlier take · the script or voice settings have changed"}</p>
