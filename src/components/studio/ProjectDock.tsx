...
export function ProjectDock() {
  ...
  return <div className="border-b border-border-soft bg-surface" aria-label="Current studio project">
    <div className="mx-auto max-w-6xl px-6 py-3">
      ...
      {project?.example === "velune" && <p className="mt-2 text-xs text-muted">VELUNE working copy · Blender study and concept artwork loaded · {project.assets.some((a) => a.id === "velune-final" && a.status === "ready") ? "Final film attached to this project" : "Final Seedance film pending"}. Loading an example never generates or spends.</p>}
