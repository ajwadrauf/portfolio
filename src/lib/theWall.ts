...
export const WALL_BEATS = [
  {
    ...
    body: "The lens sits 8 mm off the ground, orbiting one hero chip through 40 degrees. Four chips span a 36 mm frame. The shot allows no horizon. A flat bed cannot deliver that at any framing, so the bed got mounds, a berm behind the hero, and a shallow trench for the lens to run in.",
  },
  {
