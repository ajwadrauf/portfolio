...
export const DELIVERABLES: DeliverableSpec[] = [
  ...
  },
  {
    ...
    kind: "still",
    aspect: "9:16",
    description: "A vertical campaign image for Stories / Reels / in-store screens.",
  ...
  },
  {
    ...
    kind: "still",
    aspect: "1:1",
    description: "Canadian French promo copy; use approved-hero local layouts for an identical EN/FR composition.",
    rationale: "EN/FR duplication doubles Canadian retail content volume; automating it is the studio's clearest win.",
    modelOptions: ["nano-banana-pro"],
    defaultModel: "nano-banana-pro",
    usesProductImage: true,
    buildPrompt: (brief) =>
      `${stillBase(brief)} Square 1:1 retail promo tile in the campaign's visual style. Render the headline text "${brief.headlineFR}" in clean bold modern typography integrated into the composition, high contrast, fully legible. No other text.`,
  },
  {
    id: "seasonal_variant",
  ...
  },
  {
    ...
    rationale: "Turns one photo into a finished motion deliverable with sound.",
    modelOptions: ["veo-3.1-fast", "veo-3.1", "seedance-2.5", "runway-gen4"],
  ...
  {
    id: "social_cutdown",
    label: "Social Variation (5s, 9:16)",
    kind: "video",
    aspect: "9:16",
    description: "Vertical short-form cut on the cost-efficient tier.",
    rationale: "An independently generated vertical variation. Compare the current model estimate before choosing a volume tier.",
    modelOptions: ["kling-3.0", "seedance-2.5", "runway-gen4"],
