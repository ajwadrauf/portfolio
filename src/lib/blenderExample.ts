...
Orange disc: A thick, golden peanut butter chocolate chip cookie, with a craggy surface, studded with chocolate chips and peanut butter chips, matching the cookie pictured on [Image1].
...
Where the cookie makes contact, chips are displaced outward in a low ring, with individual chips rolling, tumbling and knocking into each other, not sliding together as a sheet.
...
A bow wave of chips builds and spills at its leading edge, with chips riding up the front face, tumbling over the top of it and rolling down the sides.
...
The pack stops with roughly the bottom eighth of its height still buried, with chips banked up against the base at about the top of the black base band, uneven around the perimeter, higher on one side than the other. It is seated in the bed, not standing on it.
