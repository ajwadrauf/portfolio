...
export function composeBlenderBuildBrief(b: BlenderBrief): string {
  ...
  out.push(
    ...
    "",
    "- Does a SUBJECT move at constant velocity? Fix the easing. The camera is",
    "  allowed to; a falling object is not.",
    "- Is the camera aimed by a constraint on a named empty, with its rotation",
    "  unkeyed?",
