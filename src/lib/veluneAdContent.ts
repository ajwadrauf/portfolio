...
[Exclusions]
No portrait close-ups or faces in the opening and ending. No extra workers, extra limbs, changing product counts outside the specified overrides, duplicated cartons, mirrored lettering, warped packaging, changed flavour colours, toy-like gloss, fluorescent filling, watery caramel, random particles, camera shake, inserted cuts, transitions between flavour cartons, watermarks or invented copy. Preserve the deliberate S05 chocolate merge; it is not an unwanted morph.`;
