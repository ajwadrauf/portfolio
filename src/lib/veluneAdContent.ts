...
export const VELUNE_H3_PROMPT = "Create a 15-second, 16:9 premium chocolate commercial for the fictional brand VELUNE. Use the twelve-shot edit in Video 1, the supplied Blender camera study, as the authority for camera movement, framing, scale, timing, object counts and action. The eight still images define appearance. Transform the Blender geometry into photoreal chocolate, packaging, people and environments while preserving its choreography. Do not carry over proxy colours, wireframes or viewport overlays. Treat this as one coherent film with twelve deliberate shots, not twelve unrelated clips. Keep the supplied 24 fps edit rhythm and hard cuts as closely as possible; keep the final composition alive through 15 seconds. Prioritize the guide's camera paths and cut order over decorative motion. Do not expand the creative direction with new actions, new shots or spoken lines.\n\nREFERENCE BINDINGS\nVideo 1: 00_velune_blender_motion_15s.mp4 — motion, composition and edit guide.\nImage 1: 01_velune_packaging.jpeg — the VELUNE carton family: pistachio-green Pistachio Praline, plum Raspberry Ganache, golden Salted Caramel. Match carton proportions, layout, finish and flavour colours. Show only the specified flavour during each solo carton shot; do not show the entire reference lineup in every shot.\nImage 2: 02_velune_whole_bonbon.jpeg — the rounded pillow-shaped chocolate with the moulded V groove. Carry this shell design consistently into every whole bonbon and cut half.\nImage 3: 03_velune_pistachio_centre.jpeg — the cut chocolate shell and dense, finely textured pistachio filling for the fork reveal.\nImage 4: 04_velune_caramel_centre.jpeg — the cut chocolate shell with glossy caramel contained inside, for the serving shot.\nImage 5: 05_velune_host.jpeg — the same fictional adult host throughout: face, hair and plum outfit for the tunnel and observer shots.\nImage 6: 06_velune_chocolatier.jpeg — the fictional adult chocolatier: face, hair, ivory chef jacket and plum apron.\nImage 7: 07_velune_chocolate_tunnel.jpeg — layered chocolate folds, restrained caramel veins and the small central host. Use its materials and atmosphere; retain the opening and closing framings from Video 1.\nImage 8: 08_velune_discovery_studio.jpeg — the plum-and-cream studio, two BACK-FACING workers and five bonbons arranged three on the left and two on the right. Both workers wear ivory jackets and plum aprons in this scene. This scene wardrobe takes priority over the host's plum portrait outfit.\n\nVISUAL FINISH\nTactile dark chocolate with fine moulded texture, restrained warm highlights, softly rounded edges and believable shell thickness. Muted pistachio green, rich plum, warm caramel amber, ivory and discreet gold. Satin paperboard cartons, soft studio light and clear contact shadows. Faces remain natural and consistent. Retain the guide's subject positions and viewing angles instead of copying the static framing of every reference. Focus and depth of field must keep each hero product legible.\n\nSHOT PLAN — times are seconds; preserve the corresponding cuts in Video 1.\n0.000–1.750 / S01: Chocolate folds frame the host from Image 5, with the material world of Image 7. Fixed camera. A small upward glance, slight head tilt and curious smile. Keep the guide's title space clear.\n1.750–2.125 / S02: The pistachio carton from Image 1 makes the guide's short, rigid turn on the fixed pedestal. Camera, pivot, scale and contact point remain registered.\n2.125–2.500 / S03: Hard cut to the raspberry carton from Image 1 at the same position and scale. Continue its rigid turn. No dissolve or flavour morph.\n2.500–2.875 / S04: Hard cut to the caramel carton from Image 1, preserving the same staging and turn.\n2.875–4.708 / S05: The low-centre tasting fork begins bare. Twelve bonbons matching Image 2 appear in the guide's order to form a readable question mark by approximately 3.792 seconds. Then chocolate bridges between them, closes the negative space and settles into a thick spread. Preserve the guide's silhouettes and progression, without an explosive splash.\n4.708–5.833 / S06: An already-open pistachio chocolate half matching Image 3 is held on the upright fork. Keep the fork and food steady while the two distinct observers from Image 5 and Image 6 shift behind it as in the guide. Keep one visible filling centre; do not roll the camera or fork.\n5.833–7.917 / S07: Use Image 8 for the discovery studio and Image 2 for the bonbons. Hold on two stacks, three chocolates left and two right. Around 6.833 seconds, follow the guide's actual backward camera move to reveal two back-facing workers and the console. Both workers wear ivory jackets and plum aprons. Props remain fixed in the room; no internal cut, added worker or digital zoom.\n7.917–8.625 / S08: One whole raspberry INGREDIENT rotates on the plum pedestal, already present at the cut. This is a berry, not a chocolate or a filling cutaway.\n8.625–9.292 / S09: Hard cut to an already-open pistachio nut: shell and green kernel rotate as one stable assembly. This is an ingredient, not the chocolate half from Image 3.\n9.292–10.083 / S10: One whole bonbon from Image 2 and one caramel half from Image 4 rotate together on a low cream dish. Preserve stable contact. Caramel stays contained; no new breaking, pouring or dripping action.\n10.083–13.083 / S11: Hold the guide's single flat printed-report surface for three seconds, with only its small initial settling motion. Retain its shape, perspective and graphic regions. The exact “The Centre Report” artwork will be composited onto this surface afterward. Do not turn the pictured packaging into separate moving boxes or invent extra text. There is no ninth image reference.\n13.083–15.000 / S12: Return to the wide chocolate tunnel from Video 1, using Image 7 for its look and Image 5 for the same host. Follow the small tasting/withdrawal gesture and subtle pleased expression. Keep the camera fixed and the right-hand tagline area clear. Hold living motion through the end; no additional shot or fade.\n\nSOUND AND GRAPHICS\nNo dialogue, lip-sync, singing or music. Keep any native ambience minimal and unobtrusive. The native audio will be discarded and replaced with separate ElevenLabs narration, instrumental music and spot effects after the picture edit is settled. Do not synchronize mouth movements to the external narration or change picture timing for audio. Match existing packaging artwork and logo placement as closely as possible; exact lettering, the opening title, The Centre Report and closing “Wonder within.” tagline will be finished in post. Do not add new claims, subtitles or logos.\n\n[Exclusions]\nDo not include extra people, extra limbs, extra products, duplicated cartons, changing faces, wardrobe drift, warped rigid packaging, altered flavour colours, plastic-looking chocolate, fluorescent filling, watery caramel, ice cream, random particles, camera shake, unplanned camera moves, inserted cuts, transitions between flavour cartons, watermarks or invented copy. Preserve the deliberate question-mark chocolate merge; do not confuse it with unwanted product morphing.";
